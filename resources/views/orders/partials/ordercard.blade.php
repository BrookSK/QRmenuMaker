                ...
                <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="fromDate" class="form-control" placeholder="{{ __('Date from') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="toDate" class="form-control" placeholder="{{ __('Date to') }}"
                    ...
                    <div class="col-md-3">
                        @include('partials.select', [
                            ...
                            'id' => 'payment_status',
                            'placeholder' => 'Select status',
                            'data' => ['paid' => __('Paid'), 'unpaid' => 'Unpaid'],
                            'required' => false,
                            'value' => '',
                        ])
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="restorant_id">
                                    ...
                                    @foreach ($restorants as $restorant)
                                        <option <?php if (isset($_GET['restorant_id']) && $_GET['restorant_id'] . '' == $restorant->id . '') {
                                            echo 'selected';
                                        } ?> value="{{ $restorant->id }}">{{ $restorant->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="blabla" name="client_id">
                                            ...
                                            @foreach ($clients as $client)
                                                <option <?php if (isset($_GET['client_id']) && $_GET['client_id'] . '' == $client->id . '') {
                                                    echo 'selected';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="driver_id">
                                            ...
                                            @foreach ($drivers as $driver)
                                                <option <?php if (isset($_GET['driver_id']) && $_GET['driver_id'] . '' == $driver->id . '') {
                                                    echo 'selected';
                                    ...
                                    @if ($parameters)
                                        ...
                                        <div class="col-md-4">
                                            <a href="{{ Request::fullUrl() . '&report=true' }}"
                                                class="btn btn-md btn-success btn-block">{{ __('Download report') }}</a>
                                        </div>
                                    @else
